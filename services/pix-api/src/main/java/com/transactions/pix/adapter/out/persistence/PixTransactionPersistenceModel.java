...
public class PixTransactionPersistenceModel {
    ...
    static PixTransactionPersistenceModel fromDomain(PixTransaction transaction) {
        PixTransactionPersistenceModel entity = new PixTransactionPersistenceModel();
        entity.id = transaction.id();
        entity.transactionId = transaction.transactionId();
        entity.amount = transaction.amount();
        entity.pixKey = transaction.pixKey();
        entity.description = transaction.description();
        entity.status = transaction.status();
        entity.partnerReferenceId = transaction.partnerReferenceId();
